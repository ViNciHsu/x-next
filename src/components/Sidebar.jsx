  ...
  return (
    <div className="flex flex-col p-3 justify-between h-screen sticky top-0">
      <div className="flex flex-col gap-4">
        ...
        {session ? (
          <button
            className="bg-blue-400 text-white rounded-full px-4 py-2 mt-4 hover:brightness-95 transition-all duration-200 w-48 h-9 shadow-md hidden xl:inline font-semibold"
            onClick={() => signOut()}
          >
            Sign Out
          </button>
